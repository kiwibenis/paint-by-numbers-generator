...
def test_generate_passes_process_quantization_executor_to_application(
    ...
    class FakeProcessQuantizationExecutor:
        def __init__(
            self,
        ) -> None:
            created_executors.append(
                self,
            )
    ...
    class FakeGeneratorApplication:
        def __init__(
            ...
            captured["quantization_executor"] = quantization_executor
    ...
    monkeypatch.setattr(
        ...
        FakeProcessQuantizationExecutor,
        raising=False,
    )
    monkeypatch.setattr(
        cli_main,
    ...
    assert captured["quantization_executor"] is created_executors[0]
