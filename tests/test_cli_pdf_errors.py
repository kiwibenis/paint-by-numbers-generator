...
def test_generate_reports_pdf_export_error(
    ...
    pdf_error = PdfExportError(
        "PDF legend font is not available: " "entry_font_name=DefinitelyMissingFont.",
    )
    ...
    assert (
        "PdfExportError: "
        "PDF legend font is not available: "
        "entry_font_name=DefinitelyMissingFont." in captured.err
    )
